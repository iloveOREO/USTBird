...
//#define PWM_RADIO (8000 - 4000)/1000.0
...
//  GPIO_PinAFConfig(GPIOA, GPIO_PinSource3, GPIO_AF_TIM5);
  ...
  TIM_TimeBaseStructure.TIM_Period = 299; //ACCURACY;									
...
u8 CH_out_Mapping[MAXMOTORS] = {3,4,2,1};
...
//	TIM3->CCR4 = PWM_RADIO *( pwm_tem[CH_out_Mapping[0]] ) + INIT_DUTY;				//1	
//	TIM3->CCR3 = PWM_RADIO *( pwm_tem[CH_out_Mapping[1]] ) + INIT_DUTY;				//2
//	TIM3->CCR2 = PWM_RADIO *( pwm_tem[CH_out_Mapping[2]] ) + INIT_DUTY;				//3	
//	TIM3->CCR1 = PWM_RADIO *( pwm_tem[CH_out_Mapping[3]] ) + INIT_DUTY;				//4

	TIM3->CCR4 = pwm_tem[CH_out_Mapping[0]];				//1	
	TIM3->CCR3 = pwm_tem[CH_out_Mapping[1]];				//2
	TIM3->CCR2 = pwm_tem[CH_out_Mapping[2]];				//3	
	TIM3->CCR1 = pwm_tem[CH_out_Mapping[3]];	
